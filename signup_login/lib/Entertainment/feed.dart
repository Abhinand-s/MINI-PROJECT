...
class _CategoryListState extends State<CategoryList> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(Uri.parse('https://script.google.com/macros/s/AKfycbwCEMKrOl5TNt5mOCcD-w75iAuKcvGbDy90W7eTBIZQMKCm-Z2JPeu3f5BjVMk_wlIr4w/exec'));
