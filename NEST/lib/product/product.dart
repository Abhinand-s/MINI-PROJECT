...
class _CategoryListState extends State<CategoryList1> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(Uri.parse('https://script.google.com/macros/s/AKfycbzIM9bjb-GWkpkg5mkSriV2WpZKnh7EdOd0ao0f-Tg7Zk2JjE7BJAAGTwY9OWw3whLF/exec'));
